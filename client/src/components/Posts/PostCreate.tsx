...
const PostCreate = () => {
    ...
    const handleCreatePost = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:3001/api/post/create/plus`, {
                method: 'POST',
                headers: {
        ...
        <div>
            ...
            <form onSubmit={handleCreatePost}>
                <div>
                    ...
                    <input type="text" name="pet_name" value={post.pet_name} onChange={handleInputChange} />
                </div>
                <div>
                    <label>City ID:</label>
                    <select name="city_id" value={post.city_id} onChange={handleInputChange}>
                ...
                <div>
                    ...
                    <select name="species_id" value={post.species_id} onChange={handleInputChange}>
